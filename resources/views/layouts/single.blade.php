...
<head>
    ...
    <script type="text/javascript" id="st_insights_js"
            src="http://w.sharethis.com/button/buttons.js?publisher=9f3fdeab-fbf7-49cc-b0db-e63a00f4d84b"></script>
    <script type="text/javascript">stLight.options({
            publisher: "9f3fdeab-fbf7-49cc-b0db-e63a00f4d84b",
            doNotHash: false,
            doNotCopy: false,
        ...
        <div class="container">
            <div class="header">
                ...
                <div class="logo wow fadeInDown animated logoup" data-wow-delay=".5s">
                    <h1><a href="/"><img src="/assets/img/logo/thumbnails/{{ $settings->logo }}"
                                         style="max-height: 80px;"></a></h1>
                </div>
